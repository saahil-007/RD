    ...
    <section id="heritage" className="py-20 bg-surface">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-16">
          <Badge variant="outline" className="mb-4 border-heritage text-heritage">
            <MapPin className="w-4 h-4 mr-2" />
            Regional Heritage
          </Badge>
          <h2 className="text-3xl lg:text-5xl font-playfair font-bold text-foreground mb-6">
            Four Sacred <span className="bg-gradient-sunset bg-clip-text text-transparent">Traditions</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Discover the unique kolam traditions from across India, each with its own 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {currentState.patterns.map((pattern, index) => (
            <Card key={pattern.name} className="group hover:shadow-heritage transition-all duration-300 border-border/30 bg-surface">
