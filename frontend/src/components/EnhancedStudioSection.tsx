        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="create" className="space-y-8 mt-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Card className="hover:shadow-heritage transition-all duration-300">
                <CardContent className="p-6 text-center">
                  <div className="w-12 h-12 bg-gradient-mandala rounded-lg mx-auto mb-4 flex items-center justify-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
              ...
              <Card className="text-center hover:shadow-heritage transition-all duration-300">
                <CardContent className="p-6">
                  ...
                  <h4 className="font-playfair font-semibold mb-2">Pattern Recognition</h4>
                  <p className="text-sm text-muted-foreground">
                    Identify traditional motifs and cultural origins
                  </p>
                  <Badge className="mt-2 bg-accent text-accent-foreground">94% Accuracy</Badge>
                </CardContent>
              </Card>

              <Card className="text-center hover:shadow-heritage transition-all duration-300">
                <CardContent className="p-6">
                  <div className="w-12 h-12 bg-gradient-mandala rounded-full mx-auto mb-4 flex items-center justify-center">
              ...
              <Card className="text-center hover:shadow-heritage transition-all duration-300">
                <CardContent className="p-6">
                  <div className="w-12 h-12 bg-gold rounded-full mx-auto mb-4 flex items-center justify-center">
            ...
            <Card className="bg-surface">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  <div className="text-center">
                    <div className="w-12 h-12 bg-gradient-mandala rounded-lg mx-auto mb-3 flex items-center justify-center">
                  ...
                  <div className="text-center">
                    <div className="w-12 h-12 bg-gold rounded-lg mx-auto mb-3 flex items-center justify-center">
