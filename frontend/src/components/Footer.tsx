        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              <img src="/logo.png" alt="Kolam कला Logo" className="w-10 h-10 rounded-full" />
              <div>
                <h3 className="text-2xl font-playfair font-bold">Kolam कला</h3>
                <p className="text-sm text-heritage-foreground/80">Digital Canvas</p>
              </div>
            </div>
            <p className="text-heritage-foreground/80 mb-6 max-w-md">
              Preserving and celebrating the sacred art of kolam through AI-powered 
        ...
        <div className="border-t border-heritage-foreground/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-6 text-sm text-heritage-foreground/70">
              <span>© 2024 Kolam कला. All rights reserved.</span>
