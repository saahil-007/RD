...
const Navigation = () => {
  ...
  const navItems = [
    { name: "RangDarshan", href: "#rangdarshan" },
        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              <Flower2 className="w-8 h-8 text-primary animate-lotus-bloom" />
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground font-inter">Rangoli Studio</p>
            </div>
          </div>
